...
describe('Forms Tests', () => {
    before(async () => {
        ...
        // client.addEventListener('formSubmission', evt => console.log('evt', evt));
        // conversation = await client.createGroupConversation(['c2e5d330-5ea2-4f85-aba1-2c00dac2991a'], 'topic'),
        // console.log(conversation);
        client2 = new Circuit.Client(config.bot2);
        user2 = await client2.logon();
        conversation = prep.conversation;
        // item = await client.addTextItem(conversation.convId, `${Date.now()}a`);
    });
